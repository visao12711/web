...
<html lang="en">
  <head>
    <title>Gallery | The best gallety in your life</title>
    <meta charset="utf-8">
  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			<h1 id="colorlib-logo"><a href="index.php"><span class="img" style="background-image: url(view/images/author.jpg);"></span>Your Gallery Shop</a></h1>
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="index.php">Home</a></li>
					<li><a href="index.php?act=collection">Collection</a></li>
					<li><a href="index.php?act=about">About Me</a></li>
					<li><a href="index.php?act=services">My Services</a></li>
